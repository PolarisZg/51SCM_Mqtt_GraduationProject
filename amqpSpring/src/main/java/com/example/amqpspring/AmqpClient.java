...
"阿里云的密钥" */
    ...
    private String host = "1786140596479371.iot-amqp.ap-northeast-1.aliyuncs.com";
    ...
    public AmqpClient() throws Exception{
    ...
    private void processMessage(Message message) {
        try {
            ...
            amqpMessage.setContent(content);

            String topic = message.getStringProperty("topic");
            amqpMessage.setTopic(topic);
