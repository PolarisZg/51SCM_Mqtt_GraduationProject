...
#define NRF24L01_IRQ_N  				NRF_IRQ

#define Set_NRF24L01_CE  				NRF_CEH
#define Clr_NRF24L01_CE  				NRF_CEL

#define Set_NRF24L01_CSN  			NRF_CSH
#define Clr_NRF24L01_CSN  			NRF_CSL


 
////24L01发送接收数据宽度定义
#define TRX_ADR_WIDTH    5   //5字节的地址宽度
...
#define NEF_NRF24L01_CHECK

typedef struct _tsNrf_Set
{
	unsigned char TRx_Hz;	//24L01发送接收数据频率定义50
	unsigned char TRX_PLOAD_WIDTH;	//20字节的用户数据宽度
	unsigned char TRX_ADDRESS[TRX_ADR_WIDTH];	//
	unsigned char Nrf_Data[32];
	unsigned char Nrf_Flag;	//
	
}tsNrf_Set;
extern tsNrf_Set gs_Nrf_Set;
...
void NRF24L01_Config(void);//发送与接受地址重定义
