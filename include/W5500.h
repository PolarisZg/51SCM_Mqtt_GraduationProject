...
#define W5500_RST				P47	//定义W5500的RST引脚
#define W5500_INT				P40	//定义W5500的INT引脚
#define W5500_SCS				P44	//定义W5500的CS引脚	 	
#define W5500_SCLK			P21	//定义W5500的SCLK引脚	
#define W5500_MISO			P22	//定义W5500的MISO引脚 
#define W5500_MOSI			P23	//定义W5500的MOSI引脚	 
...
/***************----- 端口数据缓冲区 -----***************/
extern unsigned char TRx_Buffer[128];	//端口接收数据缓冲区 
...
extern void Write_SOCK_Data_Buffer(SOCKET s, unsigned char *dat_ptr, unsigned short len); //指定Socket(0~7)发送数据处理
